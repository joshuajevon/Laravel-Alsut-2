<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="number" class="block mt-1 w-full" type="numeric" name="number" :value="old('number')" required autocomplete="number" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="pob" class="block mt-1 w-full" type="text" name="pob" :value="old('pob')" required autocomplete="number" />
